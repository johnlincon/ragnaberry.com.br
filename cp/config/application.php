...
return array(
	'ServerAddress'        => 'ragnaberry.com.br',              // This value is the hostname:port under which Flux runs. (e.g., example.com or example.com:80)
	'BaseURI'              => 'cp',                       // The base URI is the base web root on which your application lies.
	'InstallerPassword'    => '7ycgoDYvXa6NsP1',         // Installer/updater password.
	...
	'SiteTitle'            => 'rBerry - Painel de Controle',     // This value is only used if the theme decides to use it.
	'ThemeName'            => array('default'), // Names of the themes you would like to use.  Themes are in FLUX_ROOT/themes. First theme listed will be default theme.
	...
	'MailerFromAddress'    => 'admin@ragnaberry.com.br',      // The e-mail address displayed in the From field.
	'MailerFromName'       => 'admin@ragnaberry.com.br',             // The name displayed with the From e-mail address.
	...
	'CreditExchangeRate'   => 0.001,                      // The rate at which currency is exchanged for credits.
	'MinDonationAmount'    => 10.0,                      // Minimum donation amount. (NOTE: Actual donations made that are less than this account won't be exchanged)
	...
	'PayPalBusinessEmail'  => 'johnlincon@live.com',        // Enter the e-mail under which you have registered your business account.
	...
	'MenuItems' => array(
		...
		'Informações' => array(
			'Informações Gerais'   => array('module' => 'server', 'action' => 'info'),
			'Status do Servidor' => array('module' => 'server', 'action' => 'status'),
			'WoE Horários'     => array('module' => 'woe'),
			'Castelo'       => array('module' => 'castle'),
			"Quem está online"  => array('module' => 'character', 'action' => 'online'),
			'Estatísticas de Mapa'=> array('module' => 'character', 'action' => 'mapstats'),
			'Rank Personagens'  => array('module' => 'ranking', 'action' => 'character'),
		),
		'Database'    => array(
