...
return array(	
	...
	// Module: main
	// - main/index
	'MainPageHeading'         => 'Bem-vindo(a)! ao Painel de Controle do rBerry.',
	'MainPageInfo'            => "Use o menu localizado à esquerda para navegar, você encontrará muitas informações úteis sobre o servidor, além de criar e modificar dados de sua conta.",
	'MainPageInfo2'           => "[ADM] Linc em nome da equipe rBerry, deseja uma ótima experiência em jogo.",
	//'MainPageStep1'           => 'Abra o arquivo "%s" no seu editor de texto.',
	//'MainPageStep2'           => 'E edite o arquivo como você quiser!',
	'MainPageThanks'          => 'Obrigado por jogar no rBerry!',
	// - main/pagenotfound
