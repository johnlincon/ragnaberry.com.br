...
define('SECRET_SALT','86007227f6532857dcd822cf15f4b5b0');

#Default admin email. Used only on db connection issues and related alerts.
define('ADMIN_EMAIL','suporte@ragnaberry.com.br');
...
define('DBNAME','ragna652_osti607');
define('DBUSER','ragna652_osti607');
define('DBPASS','J8p)S986U[');

# Table prefix
define('TABLE_PREFIX','ostc4_');
